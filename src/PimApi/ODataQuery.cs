...
namespace PimApi
{
        ...
        where TEntity : BaseEntityDtoWithEndpoint, new()
    {
        ...
        /// <summary>
        /// Gets the number of records matching query
        /// </summary>
        public bool? Count { get; set; }

        /// <summary>
        /// Gets records matching a filter such as name = value
        /// </summary>
        ...
        /// <summary>
        /// Creates $top in request
        /// <para>When set responses will not return NextLink</para>
        /// </summary>
        public int? Top { get; set; }

        /// <summary>
        /// Skips number of records in matched query
        /// <para>Used for pagination</para>
        /// </summary>
        public int? Skip { get; set; }

        /// <summary>
        /// Orders results by field, for descending order 
        /// <para>For descending order: nameOfProperty desc</para>
        /// </summary>
        public string? OrderBy { get; set; }

        /// <summary>
        /// Only returns selected properties, comma delimited
        /// </summary>
        public string? Select { get; set; }

        /// <summary>
        /// Gets a single entity with given Id
        /// </summary>
