...
{
    public static int GetCount(this BaseEntityDto entity, ref int? count, string propertyName)
    {
    ...
    public static bool HasCount(this BaseEntityDto entity, string propertyName) =>
