...
public static class FileInfoExtensions
{
    ...
    public static async Task<ConnectionInformation> GetConnectionInformation(
        this FileInfo connectionFile,
    ...
    )
    {
        ...
        {
            throw new Exception(
                $"Unable to read file {connectionFile.FullName}, it does not exist!;"
            );
        }
        ...
        return connection
            ?? throw new Exception("Unable to create connection information from given file!");
    }
}
