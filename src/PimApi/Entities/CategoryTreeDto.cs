...
namespace PimApi.Entities
{
    public class CategoryTreeDto : BaseEntityDtoWithEndpoint
    {
        ...
        public ICollection<CategoryTreeDto> ChildCategoryTrees { get; set; } = new HashSet<CategoryTreeDto>();

        public ICollection<ProductCategoryTreeDto> Products { get; set; } = new HashSet<ProductCategoryTreeDto>();

        public ICollection<CategoryTreePropertyDto> Properties { get; set; } = new HashSet<CategoryTreePropertyDto>();
        ...
        public int ChildCategoryCount() =>
            this.GetCount(ref childCount, nameof(ChildCategoryTrees));

        public int ProductCount() =>
            this.GetCount(ref productCount, nameof(Products));
