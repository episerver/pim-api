...
public class PropertyDto : BaseEntityDtoWithEndpoint
{
    ...
    public System.Collections.Generic.ICollection<string> StringValueBag { get; set; } =
        new HashSet<string>();

    public System.Collections.Generic.ICollection<PropertyMappingDto> PropertyMappings { get; set; } =
        new HashSet<PropertyMappingDto>();

    public System.Collections.Generic.ICollection<TemplatePropertyDto> TemplateProperties { get; set; } =
        new HashSet<TemplatePropertyDto>();

    public System.Collections.Generic.ICollection<CategoryTreePropertyDto> CategoryTrees { get; set; } =
        new HashSet<CategoryTreePropertyDto>();
}
