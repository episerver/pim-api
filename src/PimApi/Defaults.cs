...
namespace PimApi
{
    ...
    {
        private static readonly ResourceManager resourceManager = new("PimApi.Resource", typeof(Defaults).Assembly);

        /// <summary>
        /// Used to authenticate AppKey and AppSecret for PIM access
        /// </summary>
        ...
        /// <summary>
        /// Max number of results to be returned in a single request
        /// </summary>
