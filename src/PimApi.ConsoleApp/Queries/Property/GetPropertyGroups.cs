...
/// <summary>Gets up to first 1,000 property groups with count of properties in each group</summary>
[Display(GroupName = nameof(Property), Order = 350, Description = "Shows property groups")]
public class GetPropertyGroups : IQuery, IQueryWithMessageRenderer
{
    ...
    public ApiResponseMessage Execute(HttpClient pimApiClient) =>
        pimApiClient.GetAsync(
            new ODataQuery<PropertyGroupDto>
            {
