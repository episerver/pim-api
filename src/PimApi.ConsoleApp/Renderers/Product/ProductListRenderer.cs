...
{
    public static readonly IApiResponseMessageRenderer Default = new ProductListRenderer();
    ...
    {
        var response = await apiResponseMessage.GetDataAsync<ODataResponseCollection<ProductDto>>(
            jsonSerializer
        );
    ...
    internal static void RenderProductsTable(
        Action<string> messageWriter,
