...
{
    internal static readonly IApiResponseMessageRenderer Default =
        new CategoryTaxonomyListRenderer();
    ...
    {
        var taxonomies = await apiResponseMessage.GetDataAsync<
            ODataResponseCollection<CategoryTaxonomyDto>
        >(jsonSerializer);
