    ...
    public class JsonSerializerTests
    {
        ...
        public void ShouldSerializeConnectionInformationToString(string serializerKey, bool withType)
        {
            ...
            var serializedData = jsonSerializer
                .Serialize(connectionInformation, type);
        ...
        public async Task ShouldSerializeConnectionInformationToStringAsync(string serializerKey)
        {
            ...
            var serializedData = jsonSerializer
                .Serialize(connectionInformation, typeof(ConnectionInformation));

            serializedData.Should().NotBeNullOrWhiteSpace();

            var deserializedData = await jsonSerializer
                .DeserializeAsync<ConnectionInformation>(GenerateStreamFromString(serializedData!));
        ...
        {
            public override TestConverter1? Read(ref System.Text.Json.Utf8JsonReader reader, Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
            {
                throw new NotImplementedException();
            }

            public override void Write(System.Text.Json.Utf8JsonWriter writer, TestConverter1 value, System.Text.Json.JsonSerializerOptions options)
            {
                throw new NotImplementedException();
            }
        }
