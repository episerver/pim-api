...
namespace PimApi.Tests.Queries
{
    ...
    public class WebsiteQueryTests
    {
        ...
        public async Task ShouldResolveAndDeserializeQueries(string serializerKey)
        {
            ...
            var websites = await result.GetDataAsync<ODataResponseCollection<WebsiteDto>>(jsonSerializer);
            ...
            var queryById = new GetByWebsiteId
            {
                Id = websites.Value.FirstOrDefault()!.Id
            };
